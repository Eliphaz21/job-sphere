  ...
  return (
    <div className="p-4 bg-white rounded-[24px] border border-gray-100 mb-4 hover:shadow-lg transition-all relative group shadow-sm">
      <div className="flex items-center gap-4">
        <div className={`w-14 h-14 rounded-full ${getLogoBg(job.company)} flex items-center justify-center border border-gray-50 p-2.5 shrink-0`}>
          <img src={logo} alt={job.company} className="w-full h-full object-contain brightness-0 invert" referrerPolicy="no-referrer" />
        </div>
